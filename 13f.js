...
//const companyLei = "78464A714"; // Add your company lei. 
const companyLei = "gamestop"; // Add your company lei. 
var cusip1 = "36467W109"; // shares
var cusip2 = "36467W909"; // puts
var cusip3 = "36467W959"; // calls
//36467W909 - PUT
//36467W959 - CALL
function delay(t) {
...
function process(data, original) {
	...
	parsed.informationTable.infoTable.forEach(tab => {
		if(tab.cusip.toUpperCase() === cusip1 || tab.cusip.toUpperCase() === cusip2 || tab.cusip.toUpperCase() === cusip3) {
			//console.log(tab)
...
let runner = function(page) {
	let reqParams = {
		...
		"dateRange":"all",
		"startdt":"2022-04-01", // Fill in start date for search
		"enddt":"2022-05-03", // Fill in End Date for search
		"category":"form-cat1"
	}
	if(page) {
		reqParams.page = page;
	...
	axios
	  ...
	  .then(res => {
		...
		let completeData = [];
		console.log("total files", res.data.hits.total.value)
